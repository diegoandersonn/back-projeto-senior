...
import com.example.projeto_spring.dto.transferencia.DtoListagemTransferencia;
...
public class TransferenciaController {
    ...
    public ResponseEntity listar() {
        ...
        return ResponseEntity.ok(transferencias.stream().map(DtoListagemTransferencia::new).toList());
    }
}
